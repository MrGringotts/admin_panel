...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <label for="ladder_id">Ladder ID:</label>
        <input type="text" id="ladder_id">
        <label for="team_id">Team ID:</label>
        <input type="text" id="team_id">
        ...
        <label for="result_position">Result Position:</label>
        <input type="text" id="result_position">
        <label for="win_count">Win Count:</label>
        <input type="text" id="win_count">
        <label for="loss_count">Loss Count:</label>
        <input type="text" id="loss_count">
...
<script>
    ...
    const data = [
      { id: 1, date_created: '2023-12-12 18:31:19', ladder_id: '10', team_id: '48', created_at: '2023-12-25 13:01:12', status: 'active',
        seed: 'null', result_position: 'null', win_count: '0', loss_count: '0' },
